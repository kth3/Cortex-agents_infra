...
def handle_request(req):
    ...
    if method == "tools/call":
        ...
        try:
            ...
            elif name == "pc_capsule": res = pc_capsule(args["query"], args.get("category"))
            ...
            elif name == "pc_run_pipeline": res = pc_run_pipeline(args["query"], args.get("category"))
            elif name == "pc_auto_explore": res = pc_auto_explore(args["query"], args.get("category"))
