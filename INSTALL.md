...
터미널에서 다음 명령어를 실행하십시오:
```bash
codex mcp add --env PYTHONPATH=C:/Users/SSAFY/Downloads/Workflow/PROJECT/.agents/scripts cortex-mcp -- uv run --project C:/Users/SSAFY/Downloads/Workflow/PROJECT/.agents python C:/Users/SSAFY/Downloads/Workflow/PROJECT/.agents/scripts/cortex_mcp.py
```
